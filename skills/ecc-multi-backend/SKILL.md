...
description: Codex adaptation of ECC `/multi-backend`. Codex adaptation of ECC /multi-backend.
---

# ecc-multi-backend

Use this skill when the user is asking for the ECC `/multi-backend` workflow inside Codex.

## Purpose

This skill adapts the upstream Claude-oriented command into a Codex-usable workflow. It should preserve the intent of `/multi-backend` while staying honest about missing integrations or runtime dependencies.
...
1. Restate the user's goal in the language of the `/multi-backend` workflow.
...
- Command file: `multi-backend.md`
- Original description: Codex adaptation of ECC /multi-backend.
