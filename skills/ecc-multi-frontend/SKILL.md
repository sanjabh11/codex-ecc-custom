...
description: Codex adaptation of ECC `/multi-frontend`. Codex adaptation of ECC /multi-frontend.
---

# ecc-multi-frontend

Use this skill when the user is asking for the ECC `/multi-frontend` workflow inside Codex.

## Purpose

This skill adapts the upstream Claude-oriented command into a Codex-usable workflow. It should preserve the intent of `/multi-frontend` while staying honest about missing integrations or runtime dependencies.
...
1. Restate the user's goal in the language of the `/multi-frontend` workflow.
...
- Command file: `multi-frontend.md`
- Original description: Codex adaptation of ECC /multi-frontend.
