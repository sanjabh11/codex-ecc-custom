---
name: ecc-multi-plan
description: Codex adaptation of ECC `/multi-plan`. Codex adaptation of ECC /multi-plan.
---

# ecc-multi-plan

Use this skill when the user is asking for the ECC `/multi-plan` workflow inside Codex.

## Purpose

This skill adapts the upstream Claude-oriented command into a Codex-usable workflow. It should preserve the intent of `/multi-plan` while staying honest about missing integrations or runtime dependencies.
...
1. Restate the user's goal in the language of the `/multi-plan` workflow.
...
- Command file: `multi-plan.md`
- Original description: Codex adaptation of ECC /multi-plan.
