...
description: Codex adaptation of ECC `/multi-workflow`. Codex adaptation of ECC /multi-workflow.
---

# ecc-multi-workflow

Use this skill when the user is asking for the ECC `/multi-workflow` workflow inside Codex.

## Purpose

This skill adapts the upstream Claude-oriented command into a Codex-usable workflow. It should preserve the intent of `/multi-workflow` while staying honest about missing integrations or runtime dependencies.
...
1. Restate the user's goal in the language of the `/multi-workflow` workflow.
...
- Command file: `multi-workflow.md`
- Original description: Codex adaptation of ECC /multi-workflow.
